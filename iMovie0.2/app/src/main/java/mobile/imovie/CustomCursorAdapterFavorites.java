...
public class CustomCursorAdapterFavorites extends CursorAdapter {
    public CustomCursorAdapterFavorites(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.favorites_list_template, parent, false);
    }
